...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, rightrule=.15mm, colframe=quarto-callout-note-color-frame, opacityback=0, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, breakable, colback=white, toprule=.15mm, titlerule=0mm, bottomrule=.15mm, coltitle=black, arc=.35mm, bottomtitle=1mm, leftrule=.75mm, left=2mm]
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, rightrule=.15mm, colframe=quarto-callout-warning-color-frame, opacityback=0, opacitybacktitle=0.6, colbacktitle=quarto-callout-warning-color!10!white, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warning}, breakable, colback=white, toprule=.15mm, titlerule=0mm, bottomrule=.15mm, coltitle=black, arc=.35mm, bottomtitle=1mm, leftrule=.75mm, left=2mm]
...
weighting.}\label{tbl-classified}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\end{minipage} &
...
5 4 3 2 1 & 0.12 \\
Slope (\%) & \emph{Manual (Aloui et al., 2024)} 0(min) --- 2
=\textgreater{} 2 --- 6 =\textgreater{} 6 --- 12 =\textgreater{} 12 ---
18 =\textgreater{} 18 --- 72.7(max) =\textgreater{} & 5 4 3 2 1 & 0.11 &
5 4 3 2 1 & 0.15 \\
Lineaments (Km/Km²) & \emph{Equal Int (Aloui et al., 2024)} 0(min) ---
0.5 =\textgreater{} 0.5 --- 1 =\textgreater{} 1 --- 1.5 =\textgreater{}
1.5 --- 2 =\textgreater{} 2 --- 2.6(max) =\textgreater{} & 5 4 3 2 1 &
0.04 & 1 2 3 4 5 & 0.08 \\
Drainage (Km/Km²) & \emph{Equal Int (Aloui et al., 2024)} 0(min) --- 0.5
=\textgreater{} 5 0.5 --- 1 =\textgreater{} 4 1 --- 1.5 =\textgreater{}
3 1.5 --- 2 =\textgreater{} 2 2 --- 7.6(max) =\textgreater{} 1 & 1 2 3 4
5 & 0.07 & 5 4 3 2 1 & 0.03 \\
Precipitation (mm/year) & \emph{Equal Int (br=121mm)} 284.2(min) ---
405.1 =\textgreater{} 1 405.1 --- 525.9 =\textgreater{} 2 525.9 ---
647.7 =\textgreater{} 3 647.7 --- 767.6 =\textgreater{} 4 767.6 ---
888.4(max) =\textgreater{} 5 & 1 2 3 4 5 & 0.06 & 1 2 3 4 5 & 0.05 \\
...
=\textgreater{} 1 & 5 4 3 2 1 & 0.02 & 1 2 3 4 5 & 0.02 \\
...
\pandocbounded{\includegraphics[keepaspectratio]{images/SanPedro_ElevClassified.png}}

}

\caption{\label{fig-elevClass}San Pedro elevation classification.}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/SanPedro_SlopeClassified.png}}

}

\caption{\label{fig-slopeClass}San Pedro slope classification.}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/SanPedro_LineClassified.png}}

}

\caption{\label{fig-lineClass}San Pedro lineament density
classification.}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/SanPedro_DrainClassified.png}}

}

\caption{\label{fig-drainClass}San Pedro drainage density
classification.}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/SanPedro_PrecipClassified.png}}

}

\caption{\label{fig-precipClass}San Pedro precipitation classification.}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/SanPedro_LithoClassified.png}}

}

\caption{\label{fig-lithoClass}San Pedro lithology classification.}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/SanPedro_SoilClassified.png}}

}

\caption{\label{fig-soilClass}San Pedro soil classification.}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/SanPedro_NDVIClassified.png}}

}

\caption{\label{fig-ndviClass}San Pedro NDVI classification.}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/SanPedro_LULCClassified.png}}

}

\caption{\label{fig-lulcClass}San Pedro land use/cover classification.}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/SanPedro_FloodSusceptibility.png}}
...
\subsubsection{Categorized Rasters}\label{categorized-rasters-1}
