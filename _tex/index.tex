...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, toptitle=1mm, arc=.35mm, leftrule=.75mm, breakable, opacitybacktitle=0.6, opacityback=0, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, colback=white, left=2mm, coltitle=black, colframe=quarto-callout-note-color-frame, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, titlerule=0mm, toprule=.15mm, rightrule=.15mm]
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/SanPedro_Faults.png}}

}

\caption{San Pedro fault density. Line density calculated using a 1 Km
search kernel.}
