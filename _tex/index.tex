...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, opacityback=0, toptitle=1mm, breakable, colbacktitle=quarto-callout-note-color!10!white, left=2mm, rightrule=.15mm, colback=white, coltitle=black, bottomrule=.15mm, arc=.35mm, leftrule=.75mm, opacitybacktitle=0.6, bottomtitle=1mm, toprule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, colframe=quarto-callout-note-color-frame]
...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, opacityback=0, toptitle=1mm, breakable, colbacktitle=quarto-callout-warning-color!10!white, left=2mm, rightrule=.15mm, colback=white, coltitle=black, bottomrule=.15mm, arc=.35mm, leftrule=.75mm, opacitybacktitle=0.6, bottomtitle=1mm, toprule=.15mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warning}, colframe=quarto-callout-warning-color-frame]
...
\toprule\noalign{}
Category & Flooding Susceptibility & Recharge Suitability \\
\midrule\noalign{}
\endfirsthead
\toprule\noalign{}
Category & Flooding Susceptibility & Recharge Suitability \\
