...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, opacityback=0, toprule=.15mm, colframe=quarto-callout-note-color-frame, coltitle=black, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, colbacktitle=quarto-callout-note-color!10!white, opacitybacktitle=0.6, titlerule=0mm, bottomtitle=1mm, toptitle=1mm, breakable, arc=.35mm, left=2mm, leftrule=.75mm, colback=white, bottomrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, opacityback=0, toprule=.15mm, colframe=quarto-callout-warning-color-frame, coltitle=black, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warning}, colbacktitle=quarto-callout-warning-color!10!white, opacitybacktitle=0.6, titlerule=0mm, bottomtitle=1mm, toptitle=1mm, breakable, arc=.35mm, left=2mm, leftrule=.75mm, colback=white, bottomrule=.15mm]
