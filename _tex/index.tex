...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, coltitle=black, rightrule=.15mm, colback=white, left=2mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, titlerule=0mm, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, breakable, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, bottomrule=.15mm, bottomtitle=1mm, toptitle=1mm, toprule=.15mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, coltitle=black, rightrule=.15mm, colback=white, left=2mm, colbacktitle=quarto-callout-warning-color!10!white, opacityback=0, titlerule=0mm, colframe=quarto-callout-warning-color-frame, opacitybacktitle=0.6, breakable, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warning}, bottomrule=.15mm, bottomtitle=1mm, toptitle=1mm, toprule=.15mm, leftrule=.75mm]
...
Middle Miocene to Oligocene sedimentary rocks & 1 \\
Early Pleistocene to latest Pliocene surficial deposits & 4 \\
Middle Proterozoic sedimentary rocks & 2 \\
Middle Proterozoic granitic rocks & 2 \\
Permian to Pennsylvanian sedimentary rocks & 2 \\
Jurassic sedimentary and volcanic rocks & 3 \\
Tertiary to Early Proterozoic gneissic rocks & 1 \\
Holocene river alluvium & 5 \\
\end{longtable}
