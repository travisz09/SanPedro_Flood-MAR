...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, arc=.35mm, coltitle=black, toprule=.15mm, toptitle=1mm, bottomtitle=1mm, left=2mm, colframe=quarto-callout-note-color-frame, opacityback=0, bottomrule=.15mm, titlerule=0mm, breakable, leftrule=.75mm, opacitybacktitle=0.6, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warning}, colbacktitle=quarto-callout-warning-color!10!white, rightrule=.15mm, arc=.35mm, coltitle=black, toprule=.15mm, toptitle=1mm, bottomtitle=1mm, left=2mm, colframe=quarto-callout-warning-color-frame, opacityback=0, bottomrule=.15mm, titlerule=0mm, breakable, leftrule=.75mm, opacitybacktitle=0.6, colback=white]
...
\begin{longtable}[]{@{}
  ...
  >{\raggedleft\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.0957}}
  >{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.1277}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.1915}}
  >{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.0957}}@{}}
\caption{Flood Susceptibility classification and
weighting.}\label{tbl-flood}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
\end{minipage} &
\multicolumn{2}{>{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.4149} + 2\tabcolsep}}{%
\begin{minipage}[b]{\linewidth}\raggedright
Flooding Susceptibility
\end{minipage}} &
\multicolumn{3}{>{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.4149} + 4\tabcolsep}@{}}{%
\begin{minipage}[b]{\linewidth}\raggedright
Recharge Suitability
\end{minipage}} \\
\begin{minipage}[b]{\linewidth}\raggedright
...
Weight*
\end{minipage} &
\multicolumn{2}{>{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.3191} + 2\tabcolsep}}{%
\begin{minipage}[b]{\linewidth}\raggedright
Classification Schema
\end{minipage}} & \begin{minipage}[b]{\linewidth}\raggedright
Weight*
...
=\textgreater{} 1 & 0.06 &
\multicolumn{2}{>{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.3191} + 2\tabcolsep}}{%
\emph{Equal Int (br=121mm)} 284.2(min) --- 405.1 =\textgreater{} 5 405.1
--- 525.9 =\textgreater{} 4 525.9 --- 647.7 =\textgreater{} 3 647.7 ---
767.6 =\textgreater{} 2 767.6 --- 888.4(max) =\textgreater{} 1 } & \\
