...
::: callout-note
*Section may be more properly titled* Fault Density*.*
:::

Lineaments such as faults and fractures fundamentally influence water flow dynamics (**CITATION NEEDED**).

Lineaments were obtained from the combination of two data sources, the AZ State Geologic Map (**DATA CITATION**) and the USGS Faults of Arizona maps (**DATA CITATION**). *Additional details about how the data was "merged" (**Ryan**)...*

As with the Lithology layer (see below), the faults data layer ends abruptly at the US-Mexico border.

Fault density was calculated as line density in Km of fault per Km², using a 1Km search kernel.

See @aloui2024 section 3.1.3 Lineament density (LD) for additional methods on generating lineament features from a DEM.

![San Pedro fault density. Line density calculated using a 1 Km search kernel. ](images/SanPedro_Faults.png)
