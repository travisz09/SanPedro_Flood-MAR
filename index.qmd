...
| Geologic Unit Name | Suitability Classification (1-5) |
|:-----------------------------------------------|:----------------------|
...
| Cretaceous to Late Jurassic sedimentary rocks with minor volcanic rocks | 3 |
...
| Early Tertiary to Late Cretaceous muscovite-bearing granitic rocks | 1 |
...
+-----------+-----------------------------+--------+
| Layer     | Classification Schema       | Weight*|
+:==========+:============================+=======:+
|Elevation  | *Quantiles* <br>            |   0.17 |
|           | 578(min) — 1140 => 5 <br>   |        |
|           | 1140 — 1307 => 4 <br>       |        |
|           | 1307 — 1420 => 3 <br>       |        |
|           | 1420 — 1536 => 2 <br>       |        |
|           | 1536 — 2876(max) => 1 <br>  |        |
+-----------+-----------------------------+--------+
|Slope      | *Manual [@aloui2024]* <br>  |   0.11 |
|           | 0(min) — 2 => 5 <br>        |        |
|           | 2 — 6 => 4 <br>             |        |
|           | 6 — 12 => 3 <br>            |        |
|           | 12 — 18 => 2 <br>           |        |
|           | 18 — 72.7(max) => 1 <br>    |        |
+-----------+-----------------------------+--------+
|Lineaments | *Equal Int [@aloui2024]*<br>|   0.04 |
|           | 0(min) — 0.5 => 5 <br>      |        |
|           | 0.5 — 1 => 4 <br>           |        |
|           | 1 — 1.5 => 3 <br>           |        |
|           | 1.5 — 2 => 2 <br>           |        |
|           | 2 — 2.6(max) => 1 <br>      |        |
+-----------+-----------------------------+--------+
|Drainage   | *Equal Int [@aloui2024]*<br>|   0.07 |
|           | 0(min) — 0.5 => 5 <br>      |        |
|           | 0.5 — 1 => 4 <br>           |        |
|           | 1 — 1.5 => 3 <br>           |        |
|           | 1.5 — 2 => 2 <br>           |        |
|           | 2 — 7.6(max) => 1 <br>      |        |
+-----------+-----------------------------+--------+
|Precip     | *Equal Int (br=121mm)* <br> |   0.06 |
|           | 284.2(min) — 405.1 => 5 <br>|        |
|           | 405.1 — 525.9 => 4 <br>     |        |
|           | 525.9 — 647.7 => 3 <br>     |        |
|           | 647.7 — 767.6 => 2 <br>     |        |
|           | 767.6 — 888.4(max) => 1 <br>|        |
+-----------+-----------------------------+--------+
|Lithology  | *Categorical (Neha)* <br>   |   0.09 |
|           | See @tbl-lith               |        |
+-----------+-----------------------------+--------+
|Soil       | *Categorical (Ryan)* <br>   |   0.03 |
|           | See @tbl-soil               |        |
+-----------+-----------------------------+--------+
|NDVI       | *Equal Int [@aloui2024]*<br>|   0.02 |
|           | -0.1(min) — 0 => 5 <br>     |        |
|           | 0 — 0.1 => 4 <br>           |        |
|           | 0.1 — 0.2 => 3 <br>         |        |
|           | 0.2 — 0.3 => 2 <br>         |        |
|           | 0.3 — 0.4(max) => 1 <br>    |        |
+-----------+-----------------------------+--------+
|LULC       | *Categorical (Travis)* <br> |   0.19 |
|           | See @tbl-lulc               |        |
+-----------+-----------------------------+--------+

: Flood Susceptibility classification and weighting. {#tbl-flood .striped}

\* Weights total = 0.78 ≠ 1 due to missing "Stormwater Drainage Density" layer.
